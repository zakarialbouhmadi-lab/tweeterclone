...
public class Conversation {
    ...
    private String lastMessageEncryptedKey;
    ...
    public Conversation(JSONObject json) throws JSONException {
        ...
        this.lastMessageEncryptedKey = json.optString("last_message_encrypted_key", "");
    ...
    public String getLastMessageEncryptedKey() { return lastMessageEncryptedKey; }
